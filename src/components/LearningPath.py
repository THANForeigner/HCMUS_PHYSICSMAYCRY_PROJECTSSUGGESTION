        ...
        return ft.AlertDialog(
            ...
            title=ft.Row(
                [
                    ...
                    ft.IconButton(ft.Icons.CLOSE, on_click=lambda _: self.close_dialog(),
                    ...
                    [
                        ...
                        ft.Row(
                            [
                                ft.Column(
                                    [
                                        ft.Row([ft.Icon(ft.Icons.SCHOOL_OUTLINED, color=ft.Colors.GREY_500, size=16),
                                                ft.Text("Major", size=12, color=ft.Colors.GREY_500)], spacing=4),
                                        ft.Text(project.major or "—", size=16, weight=ft.FontWeight.BOLD,
                                ...
                                ft.Column(
                                    [
                                        ft.Row([ft.Icon(ft.Icons.TIMER_OUTLINED, color=ft.Colors.GREY_500, size=16),
                                                ft.Text("Est. Time", size=12, color=ft.Colors.GREY_500)], spacing=4),
                                        ft.Text(f"{project.estimated_hours} hours", size=16, weight=ft.FontWeight.BOLD,
                                                color=ft.Colors.BLACK),
                                    ],
                                    expand=True,
                                ),
                        ...
                        ft.Row(
                            [
                                ft.Chip(
                                    label=ft.Text(project.required_material, color=ft.Colors.BLACK,
                                                  weight=ft.FontWeight.W_400, size=16),
                                    color=ft.Colors.GREY_500
                                )
                            ],
                            wrap=True,
